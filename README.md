...
![Machine Learning](https://img.shields.io/badge/Machine%20Learning-Predictive%20Model-blue)
![Python](https://img.shields.io/badge/Python-3.x-blue)
![Streamlit](https://img.shields.io/badge/Streamlit-App-red)

A machine learning web application that predicts the win probability of an IPL cricket match in real-time based on the current match situation.
